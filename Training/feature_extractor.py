...
from core.feature.feature_extraction import DrebinFeature, OpcodeSeq

if __name__ == '__main__':
    import argparse

    parser = argparse.ArgumentParser()
    parser.add_argument('-p', type=str, default='/home/lhd/androzoo/apk')
    ...
    android_features_saving_dir = '/home/lhd/MalCertain/Training/opcode'
    intermediate_data_saving_dir = '/home/lhd/MalCertain/Training/opcode'
